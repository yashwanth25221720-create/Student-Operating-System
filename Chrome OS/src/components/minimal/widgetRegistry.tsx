...
export const widgetRegistry: Record<MinimalWidgetType, WidgetDefinition> = {
  ...
  chromeSearch: { type: "chromeSearch", title: "Chrome Search", description: "Google-style search bar with shortcut tiles.", icon: Search, defaultSize: { width: 30, height: 20 }, permissions: ["tabs"], configurable: true },
  shortcuts: { type: "shortcuts", title: "App Shortcuts", description: "Quick access to app and website links with icons.", icon: Link, defaultSize: { width: 28, height: 24 }, permissions: ["tabs"], configurable: true },
