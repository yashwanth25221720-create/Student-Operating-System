...
export function Shell({
  ...
  const background = state.settings.wallpaper.value;

  return (
    <div className="app-shell" style={{ "--accent": state.settings.accentColor, background } as React.CSSProperties}>
      {state.settings.wallpaper.type === "video" && <video className="wallpaper-video" src={state.settings.wallpaper.value} autoPlay muted loop />}
